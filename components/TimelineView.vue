<template>
    <div class="w-full">
            ...
            <div class="w-full flex flex-col overflow-hidden">
                ...
                <div v-for="checked in periodBlock" class="group w-full h-7 first:h-[calc(1.75rem+1px)] relative flex flex-col flex-auto overflow-hidden">
                    ...
                    <div
                        ...
                        class="w-full h-full absolute z-10 bottom-0 group-hover:bg-blue-5 opacity-20 cursor-pointer duration-200"
                    ></div>
        ...
        <div class="w-full mt-2">
            <div class="flex flex-wrap gap-3 px-6 py-4 rounded-lg bg-gray-f">
